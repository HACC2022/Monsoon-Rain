...
Route.get('bills/office/:id', 'BillsController.getBillByOffice')
...
Route.patch('bill/action/:id', 'BillsController.updateAction')
...
Route.patch('testimony/:id', 'TestimoniesController.update')

/** Approvals */
Route.post('approval', 'ApprovalsController.create')
