...
Route.post('bills/testimonies/assign/users', 'BillsController.postAssignUsers')
Route.post('bills/testimonies/assign/offices', 'BillsController.postAssignOffices')
